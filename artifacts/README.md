...
The JSON files in this public repository are synthetic fixtures. They preserve
the application schema but do not contain real student responses, real survey
aggregates, or real quotes.
